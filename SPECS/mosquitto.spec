...
BuildRequires:  tcpd-devel, gcc-c++, python, pwdutils, libopenssl-devel, libcares-devel, libuuid-devel
...
Requires:   tcp_wrappers, openssl, c-ares
BuildRequires:  tcp_wrappers, gcc-c++, python, openssl-devel, c-ares-devel
%define WEBSOCKETS WITH_WEBSOCKETS=yes
%else
...
%else
make WITH_WRAP=yes %SRV %ECDH %UUID %WEBSOCKETS
%endif
#make test
